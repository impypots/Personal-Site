...
function Projects({ display}) {
    return (
        <div id="projects" style={{
            ...
            <ProjectNode title='MTG API Card Guessing Game' url='https://github.com/impypots/MTG-Card-Guessing-Game' source='https://wallpapermemory.com/uploads/178/magic-the-gathering-mtg-wallpaper-full-hd-455717.jpg'/>
